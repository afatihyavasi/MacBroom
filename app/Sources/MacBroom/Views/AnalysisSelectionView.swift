...
extension AnalysisTarget {
    ...
    @MainActor func displayLabel(_ loc: LocalizationManager) -> String {
        ...
        case "system:xcode-device-support": return loc.t(.targetXcodeDeviceSupport)
        case "system:pkg-caches":  return loc.t(.targetPkgCaches)
        case "system:lang-caches": return loc.t(.targetLangCaches)
        case "system:docker":      return loc.t(.targetDocker)
